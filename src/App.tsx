      ...
      <footer className="fixed bottom-0 w-full border-t border-gray-800 bg-gray-900">
        <div className="container mx-auto px-4 py-2 sm:py-4">
          <div className="text-center text-gray-400 text-xs sm:text-sm">
            <p>
              © {new Date().getFullYear()} <a href="https://0xarchit.is-a.dev/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">0xArchit</a>. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
